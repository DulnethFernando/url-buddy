    ...
    return (
        <div className="flex flex-col gap-2 justify-center items-center w-full">
            ...
            <div className="flex gap-6 mt-4">
                <button className="btn btn-primary btn-outline hover:text-white rounded-full" onClick={(e) => {
                    e.preventDefault();
                    Logout();
                }}>Logout
                </button>
                <button className="btn btn-primary text-secondary rounded-full" onClick={() => document.getElementById('my_modal_3').showModal()}>Add URL</button>
            </div>
